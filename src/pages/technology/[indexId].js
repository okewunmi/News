...
//       `https://newsdata.io/api/1/latest?apikey=pub_190253e826e13c8df31ac656b1975f4e9e42a&country=ng&category=technology`
//     );
        ...
        <section className="list">
          {relatedArticles && relatedArticles.length > 0 ? (
            relatedArticles.map((article, index) => {
              ...
              const relatedMonthString =
                monthNames[parseInt(relatedMonth, 10) - 1];
