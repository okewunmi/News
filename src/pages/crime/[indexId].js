...
//   try {
//     const response = await fetch(
//       `https://newsdata.io/api/1/latest?apikey=pub_190253e826e13c8df31ac656b1975f4e9e42a&country=ng&category=crime`
//     );
//     const data = await response.json();
...
export async function getStaticPaths() {
  try {
    const response = await fetch(
      `https://newsdata.io/api/1/latest?apikey=pub_190253e826e13c8df31ac656b1975f4e9e42a&country=ng&category=business`
    );
    const data = await response.json();
